...
@section('content')
    ...
    <div class="container-fluid">
        ...
        <div class="alert alert-primary alert-dismissible d-flex align-items-center" role="alert">
            ...
            <div><strong> Dear David Dev - </strong> We kindly encourage you to review your recent transactions and
                ...
                <div class="card card-h-100">
                    <div class="card-header border-0 justify-content-between">
                        ...
                        <div class="dropdown ms-auto">
                            ...
                            <ul class="dropdown-menu dropdown-menu-end">
                                <li>
                                    <a class="dropdown-item" href="#"> <i class="ti ti-wallet me-2"></i> Add Funds
                                    </a>
                                </li>
                                <li>
                                    <a class="dropdown-item" href="#"> <i
                                            class="ti ti-cash-banknote-move-back me-2"></i> Withdraw Funds </a>
                                </li>
                                <li>
                                    <a class="dropdown-item" href="#"> <i class="ti ti-transaction-dollar me-2"></i>
                                ...
                                <li>
                                    <a class="dropdown-item text-danger" href="#"> <i class="ti ti-lock me-2"></i>
                                        Freeze Account </a>
                                </li>
                            </ul>
                        </div>
                    ...
                    <div class="card-body pt-0">
                        ...
                        <div class="p-2 bg-light bg-opacity-50 rounded mt-3 gap-2 d-flex align-items-center">
                            ...
                            <a href="#!"
                                class="btn btn-link fw-medium text-reset ms-auto text-decoration-underline link-offset-2">Details</a>
                        </div>

                        <div class="row g-2 mt-3">
                            <div class="col">
                                <a href="#!" class="btn btn-secondary bg-gradient w-100"><i
                                        class="ti ti-coin me-1"></i> Transfer</a>
                            </div>
                            <div class="col">
                                <a href="#!" class="btn btn-info bg-gradient w-100"><i class="ti ti-coin me-1"></i>
                                    Request</a>
                            </div>
                        </div>
                    </div>
                ...
                <div class="card card-h-100">
                    <div class="card-header border-0 justify-content-between">
                        ...
                        <div class="dropdown ms-auto">
                            ...
                            <ul class="dropdown-menu dropdown-menu-end">
                                <li>
                                    <a class="dropdown-item" href="#"> <i class="ti ti-refresh me-2"></i> Refresh
                                        Data </a>
                                </li>
                                <li>
                                    <a class="dropdown-item" href="#"> <i class="ti ti-chart-bar me-2"></i> View
                                        Analytics </a>
                                </li>
                                <li>
                                    <a class="dropdown-item" href="#"> <i class="ti ti-filter-2 me-2"></i> Filter
                                        Report </a>
                                </li>
                                <li>
                                    <hr class="dropdown-divider" />
                                ...
                                <li>
                                    <a class="dropdown-item text-danger" href="#"> <i
                                            class="ti ti-download me-2"></i> Export Data </a>
                                </li>
                            </ul>
                        </div>
                    </div>
                ...
                <div class="card">
                    <div class="card-header justify-content-between">
                        <h4 class="card-title">
                            ...
                            <i class="ti ti-info-octagon text-muted ms-1" data-bs-toggle="tooltip"
                                data-bs-placement="top" data-bs-title="Quickly send money to your saved contacts."></i>
                        </h4>
                        <div class="dropdown ms-auto">
                            <a href="#" class="btn btn-sm btn-default btn-icon" data-bs-toggle="dropdown">
                                <i class="ti ti-dots-vertical fs-lg"></i>
                            ...
                            <div class="dropdown-menu dropdown-menu-end">
                                <a href="#!" class="dropdown-item"> <span class="me-2 ti ti-user-plus"></span> Add
                                    Recipient </a>
                                <a href="#!" class="dropdown-item"> <span class="me-2 ti ti-history"></span> Recent
                                    Transfers </a>
                                <a href="#!" class="dropdown-item"> <span class="me-2 ti ti-download"></span> Export
                                    Transfers </a>
                                <a href="#!" class="dropdown-item text-danger"> <span
                                        class="me-2 ti ti-trash"></span> Remove All </a>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="card-body">
                        <div class="d-flex gap-2 justify-content-center">
                            <input type="radio" class="btn-check" name="recipient" id="rec1" autocomplete="off"
                                checked />
                            <label class="avatar-label" for="rec1" data-bs-toggle="tooltip"
                                data-bs-title="Alexa Newsome">
                                <img src="assets/images/users/user-4.jpg" alt=""
                                    class="rounded-circle img-thumbnail avatar-lg" />
                            </label>

                            <input type="radio" class="btn-check" name="recipient" id="rec2"
                                autocomplete="off" />
                            <label class="avatar-label" for="rec2" data-bs-toggle="tooltip"
                                data-bs-title="Shelly Dorey">
                                <img src="assets/images/users/user-5.jpg" alt=""
                                    class="rounded-circle img-thumbnail avatar-lg" />
                            </label>

                            <input type="radio" class="btn-check" name="recipient" id="rec3"
                                autocomplete="off" />
                            <label class="avatar-label" for="rec3" data-bs-toggle="tooltip"
                                data-bs-title="Fredrick Arnett">
                                <img src="assets/images/users/user-3.jpg" alt=""
                                    class="rounded-circle img-thumbnail avatar-lg" />
                            </label>

                            <input type="radio" class="btn-check" name="recipient" id="rec4"
                                autocomplete="off" />
                            <label class="avatar-label" for="rec4" data-bs-toggle="tooltip"
                                data-bs-title="Barbara Frink">
                                <img src="assets/images/users/user-8.jpg" alt=""
                                    class="rounded-circle img-thumbnail avatar-lg" />
                            </label>

                            <input type="radio" class="btn-check" name="recipient" id="rec5"
                                autocomplete="off" />
                        ...
                        <div class="row g-3 mb-2">
                            ...
                            <div class="col-12 col-md-6">
                                ...
                                <input type="number" id="enterAmount" class="form-control" placeholder="0.00"
                                    min="1" step="0.01" />
                            </div>
                        </div>
            ...
            <div class="col-12">
                <div data-table data-table-rows-per-page="8" class="card">
                    <div class="card-header border-light justify-content-between">
                        <h4 class="card-title">Recent Transactions <span class="text-muted fw-normal fs-14">(95.6k+
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <div class="avatar-xs d-inline-block me-1">
                                            <span
                                                class="avatar-title bg-warning-subtle text-warning fw-semibold rounded-circle">
                                                S </span>
                                        </div>
                                        StorePay
                                    </td>
                                    ...
                                    <td>Debit</td>
                                    <td><img src="assets/images/cards/unionpay.svg" height="24" class="me-1" />
                                        *5510</td>
                                    <td><span class="badge bg-success-subtle text-success p-1">Success</span></td>
                                    <td>
                                        <a href="#!" class="text-muted fs-20"><i class="ti ti-eye"></i></a>
                                ...
                                <tr>
                                    ...
                                    <td>Credit</td>
                                    <td><img src="assets/images/cards/visa.svg" height="24" class="me-1" /> *0244
                                    </td>
                                    <td><span class="badge bg-success-subtle text-success p-1">Success</span></td>
                                    <td>
                                        <a href="#!" class="text-muted fs-20"><i class="ti ti-eye"></i></a>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <div class="avatar-xs d-inline-block me-1">
                                            <span
                                                class="avatar-title bg-danger-subtle text-danger fw-semibold rounded-circle">
                                                U </span>
                                        </div>
                                        Utility Co.
                                    </td>
                                    ...
                                    <td>Debit</td>
                                    <td><img src="assets/images/cards/visa.svg" height="24" class="me-1" /> *1188
                                    </td>
                                    <td><span class="badge bg-success-subtle text-success p-1">Success</span></td>
                                    <td>
                                        <a href="#!" class="text-muted fs-20"><i class="ti ti-eye"></i></a>
        ...
        <div class="d-flex align-items-center mb-3 mt-2">
            ...
            <a href="#!" class="text-decoration-underline fw-semibold fs-15 ms-auto link-offset-2 link-dark">See
                All</a>
        </div>
